...
pub fn json_response_message(num:u16, success:bool, message:&str) -> HttpResponse {
  return json_response(num, json!({
    "success": success,
    "message": message
  }));
}

pub fn json_response(num:u16, payload:JSON) -> HttpResponse {
  match num {
